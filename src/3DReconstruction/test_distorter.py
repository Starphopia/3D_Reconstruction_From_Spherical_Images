...
class TestDistorter(unittest.TestCase):
    ...
    def test_tangent_plane_vectors(self):
        ...
        print(distorter.tangent_plane_vectors((-0.90019763, 0.141120008, 0.411982246)))
        ...
        print(distorter.tangent_plane_vectors((0.4400781840, -0.8595278280, -0.2598905640)))
        ...
        print(distorter.tangent_plane_vectors((0.0011974340, -0.0653533890, 0.9978614640)))
